...
[base_rest_demo](base_rest_demo/) | 16.0.2.0.0 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Demo addon for Base REST
[base_rest_pydantic](base_rest_pydantic/) | 16.0.2.0.0 |  | Pydantic binding for base_rest
...
[extendable_fastapi](extendable_fastapi/) | 16.0.2.0.0 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Allows the use of extendable into fastapi apps
[fastapi](fastapi/) | 16.0.1.0.0 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Odoo FastAPI endpoint
...
[test_extendable_pydantic_fastapi](test_extendable_pydantic_fastapi/) | 16.0.2.0.0 |  | Tests integration between extendable_pydantic/odoo_addon_fastapi and odoo_addon_extendable_fastapi
