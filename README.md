...
--- | --- | --- | ---
[base_rest](base_rest/) | 14.0.4.7.1 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Develop your own high level REST APIs for Odoo thanks to this addon.
...
[base_rest_pydantic](base_rest_pydantic/) | 14.0.4.3.0 |  | Pydantic binding for base_rest
...
[model_serializer](model_serializer/) | 14.0.1.0.0 | [![fdegrave](https://github.com/fdegrave.png?size=30px)](https://github.com/fdegrave) | Automatically translate Odoo models into Datamodels for (de)serialization
