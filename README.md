...
--- | --- | ---
[base_rest](base_rest/) | 13.0.2.1.2 | Develop your own high level REST APIs for Odoo thanks to this addon.
[base_rest_datamodel](base_rest_datamodel/) | 13.0.1.0.0 | Datamodel binding for base_rest
[base_rest_demo](base_rest_demo/) | 13.0.2.0.1 | Demo addon for Base REST
[datamodel](datamodel/) | 13.0.1.0.0 | This addon allows you to define simple data models supporting serialization/deserialization
