...
--- | --- | --- | ---
[base_rest](base_rest/) | 14.0.4.6.0 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Develop your own high level REST APIs for Odoo thanks to this addon.
...
[base_rest_datamodel](base_rest_datamodel/) | 14.0.4.2.0 |  | Datamodel binding for base_rest
...
[base_rest_pydantic](base_rest_pydantic/) | 14.0.4.2.0 |  | Pydantic binding for base_rest
