...
--- | --- | --- | ---
[base_rest](base_rest/) | 13.0.3.1.2 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Develop your own high level REST APIs for Odoo thanks to this addon.
...
[base_rest_pydantic](base_rest_pydantic/) | 13.0.1.0.0 |  | Pydantic binding for base_rest
...
[pydantic](pydantic/) | 13.0.1.0.0 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Utility addon to ease mapping between Pydantic and Odoo models
