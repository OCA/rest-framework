...
with Python 3.6+ based on standard Python type hints. This addons let's you
...
**'fastapi'** module. You can use it to inject any dependency into your route
...
'BasiAuth' method. This authentication mechanism is implemented in the
...
* Always use an appropriate pydantic model as request and/or response for
  ...
  apply to the specific use case. For example, il you route handler is used
