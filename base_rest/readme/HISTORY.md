...
- \_validator\_...() methods can now return a cerberus `Validator` object instead of a
...
- Fix issue when rendering the jsonapi documentation if no documentation is provided on
